...
class BlockedItemTest extends MainTestCase
{
    /** @var class-string */
    protected string $model = BlockedItem::class;
    ...
    public function test_user_can_index_BlockedItem()
    {
        $this->requestPathHook($this->baseUrl . 'index');
        $this->indexTest();
    }

    public function test_user_can_show_a_BlockedItem()
    {
        $this->requestPathHook($this->baseUrl . 'show');
        $this->showTest();
    }

    public function test_user_can_create_a_BlockedItem()
    {
        $this->requestPathHook($this->baseUrl . 'store');
        $this->storeTest([]);
    }

    public function test_user_can_update_BlockedItem()
    {
        $this->requestPathHook($this->baseUrl . 'update');
        $this->updateTest([]);
    }

    public function test_user_can_delete_a_BlockedItem()
    {
