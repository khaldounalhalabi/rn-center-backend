...
class AppointmentDeductionTest extends MainTestCase
{
    /** @var class-string */
    protected string $model = AppointmentDeduction::class;

    /** @var class-string */
    protected string $resource = AppointmentDeductionResource::class;
    ...
    protected string $baseUrl = 'api.admin.appointment.deductions.';

    // if your endpoints return the model with its relation put the relations in the array
    protected array $relations = [];

    public function test_user_can_index_AppointmentDeduction()
    {
        $this->requestPathHook($this->baseUrl . 'index');
        $this->indexTest();
    }

    public function test_user_can_show_a_AppointmentDeduction()
    {
        $this->requestPathHook($this->baseUrl . 'show');
        $this->showTest();
    }

    public function test_user_can_create_a_AppointmentDeduction()
    {
        $this->requestPathHook($this->baseUrl . 'store');
        $this->storeTest([]);
    }

    public function test_user_can_update_AppointmentDeduction()
    {
        $this->requestPathHook($this->baseUrl . 'update');
        $this->updateTest([]);
    }

    public function test_user_can_delete_a_AppointmentDeduction()
    {
