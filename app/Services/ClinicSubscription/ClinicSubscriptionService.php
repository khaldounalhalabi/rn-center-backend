...
/**
 * @implements IClinicSubscriptionService<ClinicSubscription>
 * @extends BaseService<ClinicSubscription>
 */
class ClinicSubscriptionService extends BaseService implements IClinicSubscriptionService
{
    private SubscriptionRepository $subscriptionRepository;

    /**
     * ClinicSubscriptionService constructor.
     * @param ClinicSubscriptionRepository $repository
     * @param SubscriptionRepository       $subscriptionRepository
     */
    public function __construct(ClinicSubscriptionRepository $repository, SubscriptionRepository $subscriptionRepository)
    {
