                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <img
                                                                    src="https://encnniw.stripocdn.email/content/guids/CABINET_b5af318595cd7aaf49e20fb11a552bd041af109b4a93724e0a515972736abb0a/images/group_71_HPy.png"
                                                                    alt="Logo"
                                                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px"
                                                                    title="Logo" class="adapt-img" width="254"></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <img
                                                                    src="https://encnniw.stripocdn.email/content/guids/CABINET_a3448362093fd4087f87ff42df4565c1/images/78501618239341906.png"
                                                                    alt
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-txt-c"
                                                                style="padding:0;Margin:0;padding-bottom:10px"><h1
                                                                    ...
                                                                    Your password reset code</h1></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    ...
                                                                    account. Please use the following code to reset your
                                                                    password:</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                                style="Margin:0;padding-top:5px;padding-bottom:5px;padding-left:40px;padding-right:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    This code is valid for the next 15 minutes.</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" class="es-m-p0r es-m-p0l"
                                                                style="Margin:0;padding-top:5px;padding-bottom:5px;padding-left:40px;padding-right:40px">
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    If you did not request this password reset or if you
                                                                    suspect any unauthorized activity, please do not
                                                                    hesitate to contact our support team immediately at
                                                                    <a href="maileto:support@planetofmedicine.com"
                                                                       style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#5C68E2;font-size:14px">support@planetofmedicine.com</a>.
                                                                    We are available 24/7 to assist you.</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="top"
                                                                            ...
                                                                            <img title="Facebook"
                                                                                 src="https://encnniw.stripocdn.email/content/assets/img/social-icons/logo-black/facebook-logo-black.png"
                                                                                 alt="Fb" width="32"
                                                                                 style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                                                        </td>
                                                                        <td align="center" valign="top"
                                                                            style="padding:0;Margin:0"><img
                                                                                title="Instagram"
                                                                                src="https://encnniw.stripocdn.email/content/assets/img/social-icons/logo-black/instagram-logo-black.png"
                                                                                alt="Inst" width="32"
                                                                                style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                style="padding:0;Margin:0;padding-bottom:35px"><p
                                                                    ...
                                                                    Planet of Medicine © 2024. All Rights Reserved.</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%"
                                                                    ...
                                                                    <tr class="links">
                                                                        <td align="center" valign="top" width="33.33%"
                                                                            ...
                                                                            <a target="_blank"
                                                                               href="https://planetofmedicine.com"
